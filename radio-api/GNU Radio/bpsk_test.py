...
class bpsk_test(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "bpsk_test", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("bpsk_test")
        ...
        self.settings = Qt.QSettings("GNU Radio", "bpsk_test")
...
def main(top_block_cls=bpsk_test, options=None):
