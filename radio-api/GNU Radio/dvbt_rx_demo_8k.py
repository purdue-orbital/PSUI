...
class dvbt_rx_demo_8k(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Dvbt Rx Demo 8K", catch_exceptions=True)
        ...
        self.dtv_dvbt_demod_reference_signals_0 = dtv.dvbt_demod_reference_signals(
        ...
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_gr_complex*1, 'adv16.cfile', False, 0, 0)
